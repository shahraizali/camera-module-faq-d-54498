...
## Project Structure
    ...
    ├── camera_module_faq_d_54498  # Django project configurations
...
1. Clone this repo and `cd camera_module_faq_d_54498`
...
2. Clone this repo and `cd camera_module_faq_d_54498`
